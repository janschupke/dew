...
/*  The hero is `text-h1` and steps up to `text-hero` at the small breakpoint.
    ...
    The two-column grid and the picture running off the right edge are the
    `.hero` rule in theme.site.css, which says why a Container cannot hold
    both halves. Below the small breakpoint it is one column and the shot
    follows the buttons. */
export default function Home() {
  ...
  return (
    <>
      <section className="hero pt-band pb-section">
        <div>
      ...
      <Band>
        ...
        {/* Flat panels: there is nowhere for one of these to go, so none of
            them answers the pointer, and none of them wears an arrow. */}
