...
import { PageHeader, Section } from '@/ui/Prose';
      ...
      <Container className="pb-section">
        ...
        <Section title="Durations">
          <p className="text-prose leading-prose text-secondary max-w-[68ch]">
            ...
            and anything else is an exact length — different token kinds, so the two cannot be
            confused.
          </p>
        ...
        <Section title="Chords">
          <p className="text-prose leading-prose text-secondary max-w-[68ch]">
            ...
            — using <code className="text-code-small font-mono">^</code> for the inversion is what
            frees <code className="text-code-small font-mono">/</code> for{' '}
